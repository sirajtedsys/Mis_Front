...
@Component({
  selector: 'app-op-visit-summary',
  templateUrl: './op-visit-summary.page.html',
  styleUrls: ['./op-visit-summary.page.scss'],
})
export class OpVisitSummaryPage implements OnInit {
  ...
  async GetOpVisitSummaryReport(){
    ...
    this.repser.GetOpVisitSummaryReport(this.fromdate,this.todate).subscribe((data:any)=>{
      loading.dismiss()
      if(data.length>0)
      {
